...
enum ToolCatalog {
    static let builtIns: [ToolDefinition] = [
        ...
        ToolDefinition(
            ...
            dashboardURL: "http://127.0.0.1:3333/?token=stacklight-local",
            ports: [],
            startCommand: "LEAN_CTX_HTTP_TOKEN=stacklight-local nohup lean-ctx dashboard --host=127.0.0.1 --port=3333 --open=none >/tmp/stacklight-lean-ctx-dashboard.log 2>&1 &",
            stopPorts: [3333],
            metricsCommand: "lean-ctx config show 2>/dev/null | col -b | sed -n '1,14p'",
            presenceCommand: "command -v lean-ctx >/dev/null && lean-ctx --version",
        ...
        ToolDefinition(
            ...
            presenceCommand: "command -v codebase-memory-mcp >/dev/null && codebase-memory-mcp --version",
        ...
        ToolDefinition(
            ...
            presenceCommand: "command -v headroom >/dev/null && headroom --version",
        ...
        ToolDefinition(
            ...
            stopPorts: [8080],
            metricsCommand: "",
            presenceCommand: "command -v graphify >/dev/null && graphify --version",
